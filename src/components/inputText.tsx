...
const InputText = ({
  ...
  return (
    <View style={styles.mainContainer}>
      {label && (
        <Text
          style={[styles.textStyle, {color: colors.grey}, customLabelStyle]}>
          {label}
        </Text>
      )}
      ...
      {label === 'Password' || type === 'password' ? (
        <View
          style={[
            ...
            {borderColor: brColor ? brColor : colors.border},
          ]}>
          <TextInput
            style={[
              [
            ...
            onChangeText={t => onChangeText && onChangeText(removeEmojis(t))}
            value={value}
            onFocus={onFocus}
            {...props}
            blurOnSubmit={true}
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.1}>
            {!showPassword ? (
              <Icons.Ionicons color={colors.grey} name="eye" size={20} />
            ) : (
              <Icons.Ionicons color={colors.grey} name="eye-off" size={20} />
            )}
          </TouchableOpacity>
        </View>
      ) : (
